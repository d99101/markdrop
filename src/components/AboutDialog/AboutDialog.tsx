...
export function AboutDialog({ theme: t, onClose }: { theme: Theme; onClose: () => void }) {
  ...
  return (
    <Dialog theme={t} onClose={onClose} maxWidth={420}>
      ...
      <p
        style={{ fontSize: '0.875rem', color: t.textMuted, lineHeight: 1.6, margin: '0 0 1.25rem' }}
      >
        Minimal, private, offline-first. Drop a file, edit, preview. No accounts, no uploads —
